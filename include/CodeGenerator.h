...
public:
  ...
  std::any
  visitVarDeclaration(ZenithParser::VarDeclarationContext *ctx) override;
  std::any visitExpression(ZenithParser::ExpressionContext *ctx) override;
  std::any
  visitReturnStatement(ZenithParser::ReturnStatementContext *ctx) override;
  std::any
  visitPrintStatement(ZenithParser::PrintStatementContext *ctx) override;
